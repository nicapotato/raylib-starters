...
All uploads will go to `s3://dev-nicapotato-user-content/games/quickstart-c-aesprite/<VERSION>/<PLATFORM>/`.
...
Example: `s3://dev-nicapotato-user-content/games/quickstart-c-aesprite/0.0.1/mac-arm64/`
...
Example: `s3://dev-nicapotato-user-content/games/quickstart-c-aesprite/0.0.1/windows/`
...
The upload path is versioned based on `project.conf`.
Example: `s3://dev-nicapotato-user-content/games/quickstart-c-aesprite/0.0.1/wasm/`
