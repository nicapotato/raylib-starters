...
set "ZIP_NAME=quickstart-c-controller-win-x64.zip"
...
echo Uploading to s3://dev-mindtricks-user-content/apps/prototype/quickstart-c-controller/%VERSION%/windows/
aws s3 cp "%RELEASE_DIR%\%ZIP_NAME%" "s3://dev-mindtricks-user-content/apps/prototype/quickstart-c-controller/%VERSION%/windows/"
if errorlevel 1 (
