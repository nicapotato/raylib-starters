...
// include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmpgd0i14cv.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/Users/nicapotato/Documents/repo/project/raylib-starters/quickstart-rust/target/wasm32-unknown-emscripten/debug/deps/raylib_quickstart_rust.data';
      var REMOTE_PACKAGE_BASE = 'raylib_quickstart_rust.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/Users/nicapotato/Documents/repo/project/raylib-starters/quickstart-rust/target/wasm32-unknown-emscripten/debug/deps/raylib_quickstart_rust.data');

      };
      Module['addRunDependency']('datafile_/Users/nicapotato/Documents/repo/project/raylib-starters/quickstart-rust/target/wasm32-unknown-emscripten/debug/deps/raylib_quickstart_rust.data');
...
// end include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmpgd0i14cv.js
// include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmp_obm3l5q.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmp_obm3l5q.js
// include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmppwndzkxr.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/wb/qw2d5rfj7p95jckpfvkk7xsr0000gn/T/tmppwndzkxr.js
...
function findWasmBinary() {
    return locateFile('raylib_quickstart_rust.wasm');
}
...
var ASM_CONSTS = {
  96632: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 98790: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 98954: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 99058: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 99229: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 102057: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 102123: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 102516: ($0) => { miniaudio.untrack_device_by_index($0); },  
 102559: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 102684: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 102810: () => { if (document.fullscreenElement) return 1; },  
 102856: () => { return document.getElementById('canvas').width; },  
 102908: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102976: () => { document.exitFullscreen(); },  
 103003: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 103076: () => { if (document.fullscreenElement) return 1; },  
 103122: () => { return document.getElementById('canvas').width; },  
 103174: () => { return screen.width; },  
 103199: () => { document.exitFullscreen(); },  
 103226: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 103359: () => { return window.innerWidth; },  
 103385: () => { return window.innerHeight; },  
 103412: () => { if (document.fullscreenElement) return 1; },  
 103458: () => { return document.getElementById('canvas').width; },  
 103510: () => { return parseInt(document.getElementById('canvas').style.width); },  
 103578: () => { if (document.fullscreenElement) return 1; },  
 103624: () => { return document.getElementById('canvas').width; },  
 103676: () => { return screen.width; },  
 103701: () => { return window.innerWidth; },  
 103727: () => { return window.innerHeight; },  
 103754: () => { if (document.fullscreenElement) return 1; },  
 103800: () => { return document.getElementById('canvas').width; },  
 103852: () => { return screen.width; },  
 103877: () => { document.exitFullscreen(); },  
 103904: () => { if (document.fullscreenElement) return 1; },  
 103950: () => { return document.getElementById('canvas').width; },  
 104002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104070: () => { document.exitFullscreen(); },  
 104097: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 104155: () => { return screen.width; },  
 104180: () => { return screen.height; },  
 104206: () => { return window.screenX; },  
 104233: () => { return window.screenY; },  
 104260: () => { return window.devicePixelRatio; },  
 104296: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 104349: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 104420: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 104477: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 104733: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 104804: () => { if (document.fullscreenElement) return 1; },  
 104850: () => { return window.innerWidth; },  
 104876: () => { return window.innerHeight; },  
 104903: () => { if (document.pointerLockElement) return 1; }
};
...
function assignWasmExports(wasmExports) {
  ...
  Module['_custom_trace_log_callback'] = _custom_trace_log_callback = createExportWrapper('custom_trace_log_callback', 2);
  Module['_callback_0'] = _callback_0 = createExportWrapper('callback_0', 2);
  Module['_callback_1'] = _callback_1 = createExportWrapper('callback_1', 2);
  Module['_callback_2'] = _callback_2 = createExportWrapper('callback_2', 2);
  Module['_callback_3'] = _callback_3 = createExportWrapper('callback_3', 2);
  Module['_callback_4'] = _callback_4 = createExportWrapper('callback_4', 2);
  Module['_callback_5'] = _callback_5 = createExportWrapper('callback_5', 2);
  Module['_callback_6'] = _callback_6 = createExportWrapper('callback_6', 2);
  Module['_callback_7'] = _callback_7 = createExportWrapper('callback_7', 2);
  Module['_callback_8'] = _callback_8 = createExportWrapper('callback_8', 2);
  Module['_callback_9'] = _callback_9 = createExportWrapper('callback_9', 2);
  Module['_callback_10'] = _callback_10 = createExportWrapper('callback_10', 2);
  Module['_callback_11'] = _callback_11 = createExportWrapper('callback_11', 2);
  Module['_callback_12'] = _callback_12 = createExportWrapper('callback_12', 2);
  Module['_callback_13'] = _callback_13 = createExportWrapper('callback_13', 2);
  Module['_callback_14'] = _callback_14 = createExportWrapper('callback_14', 2);
  Module['_callback_15'] = _callback_15 = createExportWrapper('callback_15', 2);
  Module['_callback_16'] = _callback_16 = createExportWrapper('callback_16', 2);
  Module['_callback_17'] = _callback_17 = createExportWrapper('callback_17', 2);
  Module['_callback_18'] = _callback_18 = createExportWrapper('callback_18', 2);
  Module['_callback_19'] = _callback_19 = createExportWrapper('callback_19', 2);
  Module['_callback_20'] = _callback_20 = createExportWrapper('callback_20', 2);
  Module['_callback_21'] = _callback_21 = createExportWrapper('callback_21', 2);
  Module['_callback_22'] = _callback_22 = createExportWrapper('callback_22', 2);
  Module['_callback_23'] = _callback_23 = createExportWrapper('callback_23', 2);
  Module['_callback_24'] = _callback_24 = createExportWrapper('callback_24', 2);
  Module['_callback_25'] = _callback_25 = createExportWrapper('callback_25', 2);
  Module['_callback_26'] = _callback_26 = createExportWrapper('callback_26', 2);
  Module['_callback_27'] = _callback_27 = createExportWrapper('callback_27', 2);
  Module['_callback_28'] = _callback_28 = createExportWrapper('callback_28', 2);
  Module['_callback_29'] = _callback_29 = createExportWrapper('callback_29', 2);
