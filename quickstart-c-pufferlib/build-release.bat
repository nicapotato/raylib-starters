...
echo Uploading to s3://prod-nicapotato-public-software/apps/prototype/quickstart-c-pufferlib/%VERSION%/windows/
aws s3 cp "%RELEASE_DIR%\%ZIP_NAME%" "s3://prod-nicapotato-public-software/apps/prototype/quickstart-c-pufferlib/%VERSION%/windows/"
if errorlevel 1 (
