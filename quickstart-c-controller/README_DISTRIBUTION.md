...
All uploads use the path from the root `Makefile` (`S3_BASE_PATH`; default prototype prefix for this repo).
...
Example: `s3://dev-mindtricks-user-content/apps/prototype/quickstart-c-controller/0.0.1/mac-arm64/`
...
Example: `s3://dev-mindtricks-user-content/apps/prototype/quickstart-c-controller/0.0.1/windows/`
...
3.  Use an iframe in your component:
    ...
    ```jsx
    <iframe 
      src="/game/raylib-quickstart-c.html" 
      width="800" 
      height="450" 
      style={{ border: "none" }}
      title="Raylib Game"
...
The upload path is versioned based on `project.conf`.
Example: `s3://dev-mindtricks-user-content/apps/prototype/quickstart-c-controller/0.0.1/wasm/`
