...
set "ZIP_NAME=raylib-quickstart-c-aesprite-win-x64.zip"
...
echo Uploading to s3://prod-nicapotato-public-software/apps/quickstart/quickstart-c-aesprite/%VERSION%/windows/
aws s3 cp "%RELEASE_DIR%\%ZIP_NAME%" "s3://prod-nicapotato-public-software/apps/quickstart/quickstart-c-aesprite/%VERSION%/windows/"
if errorlevel 1 (
